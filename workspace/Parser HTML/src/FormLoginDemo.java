//This example that demonstrates how HttpClient APIs can be used to perform form-based logon.
/*
 * ====================================================================
 *
...
public class FormLoginDemo {
    static final String LOGON_SITE = "http://localhost:8080/tienda_ropa/Ingreso.jsp";
    ...
    public static void main(String[] args) throws Exception {
        ...
        NameValuePair action   = new NameValuePair("action", "/tienda_ropa/ValidarRegistroServlet");
        NameValuePair url      = new NameValuePair("url", "/Ingreso.jsp");
        NameValuePair userid   = new NameValuePair("user", "adalberto");
        NameValuePair password = new NameValuePair("password", "12345678");
